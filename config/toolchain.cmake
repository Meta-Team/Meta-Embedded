...
if(DEFINED SDK_CLEAR_ENV)
    if(DEFINED ENV{ARM_NONE_EABI_TOOLCHAIN_DIR})
        set(ARM_TOOLCHAIN_DIR "$ENV{ARM_NONE_EABI_TOOLCHAIN_DIR}/")
        MESSAGE("[Notice] Your arm-none-eabi toolchain dir is ${ARM_NONE_EABI_TOOLCHAIN_DIR}")
    else()

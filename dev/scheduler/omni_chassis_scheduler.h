...
//
/**
 * @file    omni_chassis_scheduler.h
 * @brief   Scheduler to control chassis to meet the target, including a thread to invoke PID calculation in period.
 *
 * @version 1.0
 * @date 02.22, 2023
 * @addtogroup omni_chassis
 * @{
 */

#ifndef META_EMBEDDED_OMNI_CHASSIS_SCHEDULER_H
#define META_EMBEDDED_OMNI_CHASSIS_SCHEDULER_H
...
class OmniChassisSKD: public SKDBase{
public:
...
#endif //META_EMBEDDED_OMNI_CHASSIS_SCHEDULER_H

...
#define THREAD_STUCK_DETECT_PRIO            (LOWPRIO + 5)
#define THREAD_SHOOT_BULLET_COUNTER_PRIO    (LOWPRIO + 4)
#define THREAD_SHOOT_LG_VISION_PRIO         (LOWPRIO + 3)
#define THREAD_CHASSIS_MTN_CTL_PRIO         (LOWPRIO + 2)

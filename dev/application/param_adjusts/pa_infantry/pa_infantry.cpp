    ...
    void main() final {
        ...
        while (!shouldTerminate()) {
            ...
            if (Remote::rc.s1 == Remote::S_DOWN) {
                ...
                float pitch_target;
                if (Remote::rc.ch1 > 0) pitch_target = Remote::rc.ch1 * gimbal_pitch_max_angle * 0.1f;
                else pitch_target = Remote::rc.ch1 * gimbal_pitch_min_angle * 0.1f;  // GIMBAL_PITCH_MIN_ANGLE is negative

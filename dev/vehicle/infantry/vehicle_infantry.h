...
#define GIMBAL_YAW_MOTOR_DR         (CANInterface::GM6020_DEFAULT_DECELERATION_RATIO)
#define GIMBAL_PITCH_MOTOR_DR       (CANInterface::GM6020_DEFAULT_DECELERATION_RATIO)
#define GIMBAL_SUB_PITCH_MOTOR_DR   (CANInterface::NONE_MOTOR_DEFAULT_DECELERATION_RATIO)
#define SHOOT_BULLET_MOTOR_DR       (CANInterface::M2006_DEFAULT_DECELERATION_RATIO)

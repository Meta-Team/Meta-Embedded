...
int main() {
    ...
    ShootLG::init(SHOOT_DEGREE_PER_BULLET, false, SHOOT_FW_CIRCUMFERENCE, THREAD_SHOOT_LG_STUCK_DETECT_PRIO, THREAD_SHOOT_BULLET_COUNTER_PRIO, THREAD_SHOOT_LG_VISION_PRIO);

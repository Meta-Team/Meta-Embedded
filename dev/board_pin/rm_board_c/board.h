 ...
 * IO pins assignments.
 */
#define GPIOA_USER_BUTTON           0U
#define GPIOA_PIN1                  1U
#define GPIOA_PIN2                  2U
#define GPIOA_PIN3                  3U
#define GPIOA_CS1_ACCEL             4U
#define GPIOA_SPC                   5U
#define GPIOA_SDO                   6U
...
#define GPIOC_INT1_ACCEL            4U
#define GPIOC_INT1_GYRO             5U
...
#define GPIOG_DRDY_IST8310          3U
#define GPIOG_PIN4                  4U
#define GPIOG_PIN5                  5U
#define GPIOG_RSTN_IST8310          6U
 ...
 * GPIOA setup:
 *
 * PA0  - USER_BUTTON               (input pullup).
 * PA1  - PIN1                      (input pullup).
 * PA2  - PIN2                      (input pullup).
 * PA3  - PIN3                      (input pullup).
 * PA4  - CS1_ACCEL                 (output pushpull maximum).
 * PA5  - SPC                       (alternate 5).
 * PA6  - SDO                       (alternate 5).
...
#define VAL_GPIOA_MODER             (PIN_MODE_INPUT(GPIOA_USER_BUTTON) |         \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOA_CS1_ACCEL) |       \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_USER_BUTTON) |     \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOA_CS1_ACCEL) |       \
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_HIGH(GPIOA_USER_BUTTON) |        \
                                     PIN_OSPEED_HIGH(GPIOA_PIN1) |          \
                                     PIN_OSPEED_HIGH(GPIOA_PIN2) |          \
                                     PIN_OSPEED_HIGH(GPIOA_PIN3) |          \
                                     PIN_OSPEED_HIGH(GPIOA_CS1_ACCEL) |          \
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_PULLUP(GPIOA_USER_BUTTON) |     \
                                     PIN_PUPDR_PULLUP(GPIOA_PIN1) |         \
                                     PIN_PUPDR_PULLUP(GPIOA_PIN2) |         \
                                     PIN_PUPDR_PULLUP(GPIOA_PIN3) |         \
                                     PIN_PUPDR_FLOATING(GPIOA_CS1_ACCEL) |       \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_USER_BUTTON, 0U) |        \
                                     PIN_AFIO_AF(GPIOA_PIN1, 0U) |          \
                                     PIN_AFIO_AF(GPIOA_PIN2, 0U) |          \
                                     PIN_AFIO_AF(GPIOA_PIN3, 0U) |          \
                                     PIN_AFIO_AF(GPIOA_CS1_ACCEL, 0U) |          \
 ...
 * GPIOB setup:
 *
 * PB0  - CS1_GYRO                  (output pushpull maximum).
 * PB1  - PIN1                      (input pullup).
 * PB2  - PIN2                      (input pullup).
 * PB3  - SPI1_CLK                  (alternate 5).
 * PB4  - SPI1_MISO                 (alternate 5).
 * PB5  - GPIOB_CAN2_RX             (alternate 9).
 * PB6  - GPIOB_CAN2_TX             (alternate 9).
 ...
 */
#define VAL_GPIOB_MODER             (PIN_MODE_OUTPUT(GPIOB_CS1_GYRO) |           \
...
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_CS1_GYRO) |       \
...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_HIGH(GPIOB_CS1_GYRO) |          \
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_FLOATING(GPIOB_CS1_GYRO) |         \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN1) |         \
                                     PIN_PUPDR_PULLUP(GPIOB_PIN2) |         \
                                     PIN_PUPDR_PULLUP(GPIOB_SPI1_CLK) |        \
...
#define VAL_GPIOB_ODR               (PIN_ODR_HIGH(GPIOB_CS1_GYRO) |             \
...
#define VAL_GPIOB_AFRL              (PIN_AFIO_AF(GPIOB_CS1_GYRO, 0U) |          \
 ...
 * PC4  - INT1_ACCEL                (input pullup).
 * PC5  - INT1_GYRO                 (input pullup).
...
#define VAL_GPIOC_MODER             (PIN_MODE_OUTPUT(GPIOC_OTG_FS_POWER_ON) |\
                                     ...
                                     PIN_MODE_INPUT(GPIOC_INT1_ACCEL) |           \
                                     PIN_MODE_INPUT(GPIOC_INT1_GYRO) |           \
...
#define VAL_GPIOC_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOC_OTG_FS_POWER_ON) |\
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOC_INT1_ACCEL) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOC_INT1_GYRO) |       \
...
#define VAL_GPIOC_OSPEEDR           (PIN_OSPEED_HIGH(GPIOC_OTG_FS_POWER_ON) |\
                                     ...
                                     PIN_OSPEED_HIGH(GPIOC_INT1_ACCEL) |          \
                                     PIN_OSPEED_HIGH(GPIOC_INT1_GYRO) |          \
...
#define VAL_GPIOC_PUPDR             (PIN_PUPDR_FLOATING(GPIOC_OTG_FS_POWER_ON) |\
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOC_INT1_ACCEL) |         \
                                     PIN_PUPDR_PULLUP(GPIOC_INT1_GYRO) |         \
...
#define VAL_GPIOC_ODR               (PIN_ODR_HIGH(GPIOC_OTG_FS_POWER_ON) |  \
                                     ...
                                     PIN_ODR_HIGH(GPIOC_INT1_ACCEL) |             \
                                     PIN_ODR_HIGH(GPIOC_INT1_GYRO) |             \
...
#define VAL_GPIOC_AFRL              (PIN_AFIO_AF(GPIOC_OTG_FS_POWER_ON, 0U) |\
                                     ...
                                     PIN_AFIO_AF(GPIOC_INT1_ACCEL, 0U) |          \
                                     PIN_AFIO_AF(GPIOC_INT1_GYRO, 0U) |          \
...
#define VAL_GPIOD_MODER             (PIN_MODE_ALTERNATE(GPIOD_CAN1_RX) |           \
                                     ...
                                     PIN_MODE_ALTERNATE(GPIOD_BUZZER) |          \
 ...
 * PG3  - DRDY_IST8310              (input floating).
 * PG4  - PIN4                      (input floating).
 * PG5  - PIN5                      (input floating).
 * PG6  - RSTN_IST8310              (input floating).
 * PG7  - PIN7                      (input floating).
 * PG8  - PIN8                      (input floating).
 * PG9  - UART6_RX                  (alternate 8).
 * PG10 - PIN10                     (input floating).
 * PG11 - PIN11                     (input floating).
 * PG12 - PIN12                     (input floating).
 * PG13 - PIN13                     (input floating).
 * PG14 - UART6_TX                  (alternate 8).
 * PG15 - PIN15                     (input floating).
 */
#define VAL_GPIOG_MODER             (PIN_MODE_INPUT(GPIOG_PIN0) |           \
                                     PIN_MODE_INPUT(GPIOG_PIN1) |           \
                                     PIN_MODE_INPUT(GPIOG_PIN2) |           \
                                     PIN_MODE_INPUT(GPIOG_DRDY_IST8310) |           \
                                     PIN_MODE_INPUT(GPIOG_PIN4) |           \
                                     PIN_MODE_INPUT(GPIOG_PIN5) |           \
                                     PIN_MODE_OUTPUT(GPIOG_RSTN_IST8310) |           \
...
#define VAL_GPIOG_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOG_PIN0) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOG_DRDY_IST8310) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOG_PIN4) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOG_PIN5) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOG_RSTN_IST8310) |       \
...
#define VAL_GPIOG_ODR               (PIN_ODR_HIGH(GPIOG_PIN0) |             \
                                     ...
                                     PIN_ODR_HIGH(GPIOG_DRDY_IST8310) |             \
                                     PIN_ODR_HIGH(GPIOG_PIN4) |             \
                                     PIN_ODR_HIGH(GPIOG_PIN5) |             \
                                     PIN_ODR_HIGH(GPIOG_RSTN_IST8310) |             \
...
#define VAL_GPIOG_AFRL              (PIN_AFIO_AF(GPIOG_PIN0, 0U) |          \
                                     ...
                                     PIN_AFIO_AF(GPIOG_DRDY_IST8310, 0U) |          \
                                     PIN_AFIO_AF(GPIOG_PIN4, 0U) |          \
                                     PIN_AFIO_AF(GPIOG_PIN5, 0U) |          \
                                     PIN_AFIO_AF(GPIOG_RSTN_IST8310, 0U) |          \

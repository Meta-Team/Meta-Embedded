...
public:
    ...
    static void calc_elevator(float height);
...
private:
     ...
     */
    static void calc_a2v_(float actual_angle_, float target_angle_);
     ...
     * @note for outside code, only for test.
     */
    static void calc_v2i_(float actual_velocity_, float target_velocity_);

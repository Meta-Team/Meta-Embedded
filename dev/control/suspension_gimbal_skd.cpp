...
void SuspensionGimbalSKD::set_target_signal() {
    ...
    if (SuspensionGimbalIF::yaw.enabled)
        SuspensionGimbalIF::yaw.target_signal = (int16_t) yaw_v2i_pid.calc(SuspensionGimbalIF::yaw.angular_velocity,
                yaw_a2v_pid.calc(SuspensionGimbalIF::yaw.actual_angle, SuspensionGimbalIF::yaw.target_angle));

    // Set pitch voltage
    ABS_CROP(SuspensionGimbalIF::pitch.target_angle, MAX_PITCH_ANGLE);
    if (SuspensionGimbalIF::pitch.enabled)
        SuspensionGimbalIF::yaw.target_signal = (int16_t) pitch_v2i_pid.calc(SuspensionGimbalIF::pitch.angular_velocity,
                pitch_a2v_pid.calc(SuspensionGimbalIF::pitch.actual_angle, SuspensionGimbalIF::pitch.target_angle));
}
